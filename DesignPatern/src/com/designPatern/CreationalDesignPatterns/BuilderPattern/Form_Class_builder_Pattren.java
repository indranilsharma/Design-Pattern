...
public class Form_Class_builder_Pattren {
	...
	public static class FormBuilder {
		...
		public Form_Class_builder_Pattren build() {
			return new Form_Class_builder_Pattren(this);
		}
	}

	private Form_Class_builder_Pattren(FormBuilder formBuilder) {
	...
	public static void main(String[] args) {
		Form_Class_builder_Pattren form = new Form_Class_builder_Pattren.FormBuilder("Dave", "Carter", "DavCarter", "DAvCaEr123").passwordHint("MyName").city("NY")
				.language("English").dob(new Date()).build();
